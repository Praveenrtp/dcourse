...
export default function DollarCoursesUpdateForm(props) {
  const {
    id,
    dollarCourses,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...dollarCoursesRecord };
  ...
  const [dollarCoursesRecord, setDollarCoursesRecord] =
    React.useState(dollarCourses);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id
        ? await DataStore.query(DollarCourses, id)
        : dollarCourses;
      setDollarCoursesRecord(record);
    };
    queryData();
  }, [id, dollarCourses]);
  React.useEffect(resetStateValues, [dollarCoursesRecord]);
  const validations = {
    name: [],
    title: [],
    img: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            DollarCourses.copyOf(dollarCoursesRecord, (updated) => {
      ...
      {...rest}
      {...getOverrideProps(overrides, "DollarCoursesUpdateForm")}
    >
      <TextField
        label="Name"
        isRequired={false}
